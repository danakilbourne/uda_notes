...
chrome = pw.chromium.launch(headless=False) #use headless = False for a browser to pop up, 
#True for no browser & right now you probably need to start with false
...
page.get_by_test_id("tturv-pagination").get_by_role("button", name="All").click() #click the all button
...
#this below works only right now, but it will change and you will have to check every day
